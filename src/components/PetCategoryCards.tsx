    ...
    const fetchContent = async () => {
      try {
        const { data } = await supabase
          .from('home_content')
          .select('perros_desktop, perros_mobile, gatos_desktop, gatos_mobile, aves_desktop, aves_mobile, roedores_desktop, roedores_mobile, tortugas_desktop, tortugas_mobile')
          .eq('id', '00000000-0000-0000-0000-000000000001')
          .single();
        if (data) setImages(data as SpeciesImages);
      } catch (e) {
        console.error(e);
      }
    };
